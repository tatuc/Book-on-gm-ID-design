...
C {devices/ngspice_get_value.sym} 1120 -170 0 0 {name=r1 node=v(@m.xm1.msky130_fd_pr__nfet_01v8[vth])
descr="Vt="}
...
C {devices/ngspice_get_value.sym} 1010 -290 0 0 {name=r2 node=@m.xm1.msky130_fd_pr__nfet_01v8[cgg]
descr="cgg="}
...
descr="gm/gds="}
C {devices/ngspice_get_value.sym} 1010 -250 0 0 {name=r3 node=@m.xm1.msky130_fd_pr__nfet_01v8[capbd]
descr="capdb="}
C {devices/ngspice_get_value.sym} 1010 -210 0 0 {name=r5 node=@m.xm1.msky130_fd_pr__nfet_01v8[capbs]
descr="capbs="}
...
C {devices/ngspice_get_value.sym} 1010 -170 0 0 {name=r8 node=@m.xm1.msky130_fd_pr__nfet_01v8[cgdo]
descr="cgdo="}
C {devices/ngspice_get_value.sym} 1010 -130 0 0 {name=r9 node=@m.xm1.msky130_fd_pr__nfet_01v8[cgso]
descr="cgso="}
